...
# u2netp = lightweight u2net (~4.7MB vs 176MB). Same portrait quality, ~10x less
# RAM at inference — full u2net can 'bad_alloc' on low-memory Windows machines.
...
gray = cv2.convertScaleAbs(gray, alpha=1.08, beta=28)
