...
# ===========================================================================
HOST = "mushfiq"   # shown as  mushfiq@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now",   "Final-year ECE @ North South University"),
    ("kv", "Focus", "AI / ML projects & research"),
    ("kv", "Prev",  "Frontend & academic software projects"),
    ("kv", "Also",  "Deep Learning, CV, NLP, open source"),
    ("kv", "Edu",   "B.Sc. ECE, NSU, Dhaka"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI / ML",   "PyTorch, TensorFlow, scikit-learn"),
    ("kv", "CV / NLP",  "OpenCV, NumPy, Pandas"),
    ("kv", "Languages", "Python, C, C++, Java, JS"),
    ("kv", "Web",       "React, HTML, CSS"),
    ("kv", "Data",      "MySQL, MongoDB, Git"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Deep Learning building semantic segmentation"),
    ("bul", "AI financial advisor (NLP)"),
    ("bul", "Computer vision & pattern recognition"),
    ("bul", "Full-stack AI applications"),
]
